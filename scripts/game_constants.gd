...
const TOKEN_BOXED_Y_POS: float = 80
const TOKEN_PLACED_Y_POS: float = 60
const TOKEN_FLOATING_Y_POS: float = 85
const TOKEN_IN_RANGE_Y_POS: float = 65

const TOKEN_SHADOW_Y_POS: float = - 15
